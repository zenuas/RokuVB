...
Namespace Manager
    ...
    Public Class RkCILArrayNamespace
        ...
        Public Overrides Sub CreateFunctionCache()
            ...
            Dim get_Item_r As New RkCILReplacedFunction With {.Scope = Me, .Name = get_Item.Name, .MethodInfo = get_Item.MethodInfo}
            ...
            Dim set_Item_r As New RkCILReplacedFunction With {.Scope = Me, .Name = set_Item.Name, .MethodInfo = set_Item.MethodInfo}
